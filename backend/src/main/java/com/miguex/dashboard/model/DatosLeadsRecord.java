...
/**
 * Un lead normalizado para el tablero "Datos" (una fila = un lead). Tabla propia.
 */
@Entity
@Table(name = "datos_leads", indexes = {
        @Index(name = "idx_datosleads_fecha", columnList = "fecha"),
        @Index(name = "idx_datosleads_semana", columnList = "semana")
})
public class DatosLeadsRecord implements DatosRow {
